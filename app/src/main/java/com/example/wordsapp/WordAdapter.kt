...
class WordAdapter(private val letterId: String, context: Context) :
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            ...
            //Start by creating a URI for the search query.
            ...
            // Even though you aren't launching any particular activity in your app, you're telling the system to launch another app, by calling startActivity()and pass in the intent.
