...
class DetailActivity : AppCompatActivity() {
    // A way to define a constant that can be used across multiple classes, while keeping your code organized is with the "companion objects"
    // We will use a companion object as a way to organize constants and make them accessible outside of the DetailActivity.
    companion object{
